                            ...
                            <div class="panel panel-info">
                                <div class="panel-body">
                                    ...
                                    {{--<form method="post" action="{{ url("/suggestions/{$ordinances->id }/") }}">--}}
                                        ...
                                        {{--</div>--}}
                                    {{--</form>--}}
                                    {{--<iframe src = "/ViewerJS/#../storage/ordinances/3Ordinanceasdasd.pdf" width='400' height='300' allowfullscreen webkitallowfullscreen></iframe>--}}
