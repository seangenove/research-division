    ...
    <div class="col-md-8">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <strong>Resolution {{$resolution->number}}</strong> : Upload New Update Report
                </h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            @if($resolution->is_monitoring == 1)
                <form method="POST" action="{{ route('resolutionStoreUpdateReport') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="box-body">
